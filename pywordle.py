...
class pyWordle:
    ...
    def start(self):
        ...
        self.input = tk.Entry(self.inputFrame, bg = self.wGrey, width = 10, relief = 'flat', textvariable=self.guessInput)
        self.guessInput.trace("w", lambda *args: self.charLimiter())

        self.feedback = tk.Label(self.inputFrame, text = "", bg = self.dBG, fg = self.wRed)
        self.goButton = tk.Button(self.inputFrame, bg = self.wGrey, text = "Guess!", relief = 'flat', command = lambda: self.checkGuess())

        self.kb1 = tk.Frame(self.master, bg = self.dBG)
        self.kb2 = tk.Frame(self.master, bg = self.dBG)
        self.kb3 = tk.Frame(self.master, bg = self.dBG)

        self.titleLabel.grid(row = 0, column = 0, columnspan = 5, padx = 5, pady = 1)
        ...
        self.guessLabel.grid(row = 0, column = 0, padx = 3, pady = 10)
        self.input.grid(row = 0, column = 1, padx = 3, pady = 10)
        self.goButton.grid(row = 0, column = 2, padx = 3, pady = 10)
        self.feedback.grid(row = 1, column = 0, columnspan = 3, pady = 1)
    ...
    def charLimiter(self):
        if(len(str(self.guessInput.get())) > self.numChars):
